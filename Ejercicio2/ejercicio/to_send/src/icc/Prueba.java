...
//====================================
//Rombo V
    public static void romboV(int max) {
        // int espStart = max - 1;
        for(int i = 1; i <= max; i++) {
            //Imprime espacios en blanco a la izquiera (max -i)
        ...
        for(int i = 1; i <= max; i++) {
            //Imprime espacios en blanco a la izquiera
            for (int k = 1; k <= i; k++) {
                 Colors.print(" ", Colors.CYAN);
            }
            for (int j = i; j <= max; j++) {
...
//====================================
//Reloj de arena V
    public static void clockSandVI(int max) {
        for(int i = 1; i <= max; i++) {
            //Imprime espacios en blanco a la izquiera
            for (int k = 1; k <= i; k++) {
                 Colors.print(" ", Colors.CYAN);
